...
*/
// Base address of TX Normal FIFO
uint32_t MAC_TXN_BASE_ADDR(void);

// Base address of TX GTS1 FIFO
uint32_t MAC_TXG1_BASE_ADDR(void);
...
{
    mac_isrsts_t IntIn;
    mac_isrsts_t IntProc;
    mac_intmsk_t IntMask;
    ...
    mac_tx_given_time_set_t tx_given_time_set_saved;
    ...
    mac_rx_prg_reg_2w_t rx_prg_reg_2w;
    mac_rx_bkrpt0w_t rx_bkrpt0w;
    mac_rx_bkrpt1w_t rx_bkrpt1w;
...
/**
*
* @fn uint8_t  mac_GetRxFrmShortAddr(void)
*
...
/**
*
* @fn void mac_GetCcaEDThreshold(mac_cca_mode_t cca_mode)
*
...
static __inline uint8_t  mac_LoadTxNPayload(uint8_t HdrL, uint8_t FrmL, uint8_t *TxFIFO)
{
    ...
    mac_adapter.memcpy((void *)pTxNFIFO->payload, TxFIFO, FrmL); //write data into tx normal fifo
...
*
* @param is_share_lan indicate to PTA hardware for whether RF is sharing
*                     LNA with WLan, default is 'true'
*
* @return None
*
*/
void mac_PTA_ShareLNA(uint8_t is_share_lan);
